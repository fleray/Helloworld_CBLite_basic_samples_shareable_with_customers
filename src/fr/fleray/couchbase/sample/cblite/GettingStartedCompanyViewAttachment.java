...
public class GettingStartedCompanyViewAttachment {
	...
	private static final String SYNC_GATEWAY_URL = "ws://localhost:4984/company"; // "ws://52.174.108.107:4984/stime";
	private static final String DB_PATH = new File("").getAbsolutePath() + "/company";
