...
public class GettingStartedForvia {
...
//		System.out.println(String.format("Total rows returned by query = %d", numRows));
			...
			// pour détails
//			URL url = GettingStartedForvia.class.getClassLoader().getResource("charcoal-piranha-ForviaAppSrv.cer");
			Path path = Paths.get(ClassLoader.getSystemResource("charcoal-piranha-ForviaAppSrv.cer").toURI());
//			Path path = Paths.get("/Users/fabriceleray/temp/charcoal-piranha-ForviaAppSrv.cer");
//			Path path = Paths.get("/home/pi/charcoal-piranha-ForviaAppSrv.cer"); // Raspberry PÏ folder (hard-coded)
//			Path path = Paths.get("/Users/fabriceleray/eclipse-workspace/Helloworld_CBLite_basic_samples_shareable_with_customers/resources/charcoal-piranha-ForviaAppSrv.cer");
